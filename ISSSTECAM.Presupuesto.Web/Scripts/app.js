...
$(function () {
    habilitarMenu($('.sidebar'));
});

function habilitarMenu(contexto) {
    $('.ajax', contexto).click(function (evento) {
        evento.preventDefault();                         
        $.ajax({
            url: this.href,
            success: function (html) {
                $('#cuerpo').html(html);
                habilitarFuncionalidad($('#cuerpo'));
            },
...
function habilitarFuncionalidad(contexto) {
    habilitarPeticionesParciales(contexto);
}

function habilitarPeticionesParciales(contexto) {
    $('.ajax', contexto).click(function (evento) {
        evento.preventDefault();
        
        $.blockUI({
            message: 'Cargando opción...',
            css: {
                border: 'none',
                padding: '15px',
                backgroundColor: '#000',
        ...
        $.ajax({
            ...
            success: function (html) {
                contexto.html(html);
                habilitarFuncionalidad(contexto);
                $.unblockUI();
            }
        });
